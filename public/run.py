...
def interface(task_name,failcount,email_data):
    ...
    task_dir=os.getcwd()+"\\task\\" + task_name
    ...
    def createSuite():
        ...
        #print(case_dir)
        #print(case_names_weights)
        #print(os.path.abspath(os.path.join(task_dir, "..\\")))
        #start_dir = "C:\\Users\\zhangjian01\\PycharmProjects\\AAP2\\task\\0605\\testcase"
