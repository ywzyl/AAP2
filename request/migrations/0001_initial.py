# Generated by Django 2.2.1 on 2019-06-05 02:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_host', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True)),
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('step', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.Step')),
            ],
        ),
        migrations.CreateModel(
            name='Reference_step',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('step_name', models.CharField(default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.Project')),
            ],
        ),
        migrations.AddField(
            model_name='case',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.Case')),
                ('step', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.Step')),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.Task')),
            ],
        ),
    ]
