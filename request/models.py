...
class Environment(models.Model):
    env_ip = models.CharField(max_length=200)
    env_host = models.CharField(max_length=200)
    env_port = models.CharField(max_length=20)
    env_desc = models.CharField(max_length=200)
...
class Database(models.Model):
    ...
    db_typename = models.CharField(max_length=200,default="")
...
class Step(models.Model):
    ...
    step_desc = models.CharField(max_length=50)
    steplevel = models.CharField(max_length=20)
...
class Reference_step(models.Model):
    ...
    step_name = models.CharField(max_length=50,default="")
